...
customElements.define("my-calculator", class extends HTMLElement {
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        const myCalc = (_a = this === null || this === void 0 ? void 0 : this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector(".calc-container");
        const property = name === "width" ||
            name === "height" ||
            name === "margin" ||
            name === "calc-name" ||
            name === "calc-input"
            ? name
            : "borderRadius";
        const calcHeader = myCalc === null || myCalc === void 0 ? void 0 : myCalc.querySelector(".calc-heading > p");
        if (property === "calc-name" &&
            (newValue === null || newValue === void 0 ? void 0 : newValue.trim()) !== "" &&
            (calcHeader === null || calcHeader === void 0 ? void 0 : calcHeader.textContent)) {
            calcHeader.textContent = newValue;
        }
        else if (property === "calc-input" &&
            /^[\d\.\+\-\x\/\^\!\(\)]+$/.test(newValue)) {
            const inputElem = myCalc === null || myCalc === void 0 ? void 0 : myCalc.querySelector("#output > input");
            if (!(inputElem === null || inputElem === void 0 ? void 0 : inputElem.value))
                return;
            inputElem.value = newValue;
            inputElem.focus();
        }
        else if (myCalc === null || myCalc === void 0 ? void 0 : myCalc.style) {
    ...
    setOnclickForAllKeys(shadowRoot) {
        ...
        calcKeys.addEventListener("click", (e) => {
            var _a;
            switch ((_a = e === null || e === void 0 ? void 0 : e.target) === null || _a === void 0 ? void 0 : _a.id) {
                case "reset-key":
                    onResetKeyClick();
                    break;
                case "inverse-key":
        ...
        calcKeys.addEventListener("keydown", (e) => {
            var _a, _b;
            if ((_b = (_a = e === null || e === void 0 ? void 0 : e.target) === null || _a === void 0 ? void 0 : _a.className) === null || _b === void 0 ? void 0 : _b.includes("calc-key")) {
                ...
                if ((e === null || e === void 0 ? void 0 : e.key) === " ") {
                    ...
                    setTimeout(() => {
                        if (calcKey.id !== "squared-key" &&
                            ...
                            (shadowRoot === null || shadowRoot === void 0 ? void 0 : shadowRoot.querySelector("#backspace-key")).click();
                        calcKey.focus();
                    }, 1);
                }
            }
                                            ...
                                            : key === "/"
                                                ...
                                                : key === "^"
                                                    ...
                                                    : key === "Escape"
                                                        ...
                                                        : null;
            if (keyToBeClicked)
                (shadowRoot === null || shadowRoot === void 0 ? void 0 : shadowRoot.querySelector(`#${keyToBeClicked}`)).click();
    ...
    parseFactorialInput(text) {
        ...
        if (prevChar === ")") {
            ...
            parsedArr.splice(index, prevCharIndex - index + 2, factorialResult.toString());
        ...
        parsedArr.splice(prevCharIndex + 1, power + 1, factorialResult.toString());
        return parsedArr.join("");
    }
    getFactorialOf(num) {
        if (num === 0) {
